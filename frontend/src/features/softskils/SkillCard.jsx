...
export default function SkillCard({ skill }) {
  // جلب الأيقونة ديناميكياً من lucide-react
  const IconComponent = Icons[skill.icon] || Icons.HelpCircle;

  // تحديد ألوان ديناميكية بناءً على نوع المهارة
  const colorClasses = {
  ...
  // حساب محيط الدائرة للـ SVG Progress
  const radius = 18;
  ...
  return (
    <div className="bg-white rounded-3xl p-6 border border-gray-100 shadow-sm flex flex-col justify-between h-[260px] relative text-right">
      ...
      {/* الهيدر العلوي للكارد: يحتوي على الأيقونة ودائرة النسبة */}
      ...
      {/* الجزء السفلي: عدد الكورسات وزر الإجراء */}
