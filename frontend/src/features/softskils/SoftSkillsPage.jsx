  ...
  return (
    <div className="p-4 md:p-8 max-w-[1400px] mx-auto bg-[#F9FAFC] min-h-screen text-right" dir="rtl">
      ...
      <div className="bg-white rounded-3xl p-6 md:p-8 mb-8 border border-gray-100 shadow-sm relative overflow-hidden flex flex-col justify-center min-h-[160px]">
        {/* الخلفية المزخرفة الدائرية في الفيجما */}
      ...
      {/* 2. التقسيم الرئيسي (المحتوى الأساسي + الشريط الجانبي) */}
      <div className="flex flex-col lg:flex-row gap-8">
        
        {/* الجزء الأيمن (المحتوى الرئيسي للمهارات والدورات) */}
        <div className="flex-1 order-2 lg:order-1">
          
          {/* قسم استكشف المهارات الأساسية */}
          ...
          {/* شبكة بطاقات المهارات (2 في كل صف) */}
        ...
        {/* الجزء الأيسر (الشريط الجانبي للإحصائيات والشهادات) */}
